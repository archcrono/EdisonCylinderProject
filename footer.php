...
<div class="navButtonContainers" style="opacity: 1;">
  <i id="searchButton" style="cursor: pointer;" class="fa fa-search" aria-hidden="true"><span>Search</span></i>
  <i id="homeButton" style="cursor: pointer; color: green;" class="fa fa-home navButton" aria-hidden="true"><span>Home</span></i>
